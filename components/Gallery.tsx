      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Działam też jako prelegent
            </h2>
            <p
              className="text-base leading-relaxed"
              style={{ color: "var(--text-muted)" }}
            >
              Swoją wiedzę na temat treningu siłowego i trójboju dzielę nie tylko
              na sali, ale również ze sceny. Biorę udział w konferencjach
              branżowych jako prelegent — przekazując praktyczne doświadczenie
              trenerskie szerszemu gronu słuchaczy.
            </p>
          </div>
